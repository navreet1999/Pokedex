      ...
      <section className="pokemon-body">
        ...
        {error && (
          <div className="error-container">
            ...
            <p className="error-text sub-title">
              Try these suggestions to find a pokemon
            </p>
            <ul className="suggestions">
              <li>
                <p className="error-text">
                  Reduce the number of search characters
                </p>
              </li>
              <li>
                <p className="error-text">
                  Search only for one pokemon at a time
                </p>
              </li>
              <li>
                <p className="error-text">
                  Do not type special characters, only letters or numbers (not
                  both at the same time)
                </p>
              </li>
              <li>
                <p className="error-text">
                  If you know the Pokemon's ID, you can type the number on the
                  search box
                </p>
              </li>
            </ul>
